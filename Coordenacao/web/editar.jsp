...
<%
    ...
    String sql_cursos = "SELECT  id, descricao FROM cursos";
    ...
    String sql_disciplinas = "SELECT id, descricao FROM disciplinas";
    ...
    String sql_estudantes = "SELECT * FROM estudantes ";

    // Criar STATEMENT para estudantes
    PreparedStatement stmt_estudantes = conexao.prepareStatement(sql_estudantes);

    // Ordenar execucao do SQL e receber o conjunto de resultados para ESTUDANTES
    ResultSet rs_estudantes = stmt_estudantes.executeQuery();
